    ...
    <div class="row">
        ...
        <div class="col-lg-8 mb-3 mb-lg-0  py-3 px-3 py-lg-6 px-lg-6">
            ...
            <div class="row">
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="/metronic8/demo1/?page=index" class="menu-link active">
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="/metronic8/demo1/?page=dashboards/ecommerce" class="menu-link ">
                                <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="/metronic8/demo1/?page=dashboards/projects" class="menu-link ">
                                <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="/metronic8/demo1/?page=dashboards/online-courses" class="menu-link ">
                                <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="/metronic8/demo1/?page=dashboards/marketing" class="menu-link ">
                                <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="/metronic8/demo1/?page=dashboards/bidding" class="menu-link ">
                                <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="/metronic8/demo1/?page=dashboards/pos" class="menu-link ">
                                <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="/metronic8/demo1/?page=dashboards/call-center" class="menu-link ">
                                <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
            ...
            <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-2 mx-5">
                ...
                <a href="/metronic8/demo1/?page=landing" class="btn btn-sm btn-primary fw-bold">
                    Explore
                </a>
            </div>
            <!--end:Landing-->
        ...
        <div class="menu-more bg-light col-lg-4 py-3 px-3 py-lg-6 px-lg-6 rounded-end">
            ...
            <!--end:Heading-->
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="/metronic8/demo1/?page=dashboards/logistics" class="menu-link py-2 ">
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="/metronic8/demo1/?page=dashboards/website-analytics" class="menu-link py-2 ">
                        <span class="menu-title">
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="/metronic8/demo1/?page=dashboards/finance-performance" class="menu-link py-2 ">
                        <span class="menu-title">
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="/metronic8/demo1/?page=dashboards/store-analytics" class="menu-link py-2 ">
                        <span class="menu-title">
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="/metronic8/demo1/?page=dashboards/social" class="menu-link py-2 ">
                        <span class="menu-title">
                            Social                        </span>
                    </a>
                    <!--end:Menu link-->
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="/metronic8/demo1/?page=dashboards/delivery" class="menu-link py-2 ">
                        <span class="menu-title">
                            Delivery                        </span>
                    </a>
                    <!--end:Menu link-->
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="/metronic8/demo1/?page=dashboards/crypto" class="menu-link py-2 ">
                        <span class="menu-title">
                            Crypto                        </span>
                    </a>
                    <!--end:Menu link-->
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="/metronic8/demo1/?page=dashboards/school" class="menu-link py-2 ">
                        <span class="menu-title">
                            School                        </span>
                    </a>
                    <!--end:Menu link-->
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="/metronic8/demo1/?page=dashboards/podcast" class="menu-link py-2 ">
                        <span class="menu-title">
                            Podcast                        </span>
                    </a>
                    <!--end:Menu link-->
